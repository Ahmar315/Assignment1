...
(8,'Syed','Danish',15,19),
(9,'Kinza','Tayyab',null,19),
(10,'Muhammad','Umair',null,22)
...
Select Courses.CourseName from Courses LEFT JOIN Students ON Courses.CourseID=Students.CourseID 
WHERE Students.CourseID IS NULL

--students who share courses with a specific student (choose one from your records
Select * FROM Students 
Where CourseID =(Select CourseID from Students Where ID=15)
